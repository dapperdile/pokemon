...
class Pokemon_main:
    ...
    def pokeInput(self, pokelist, random_allow_1=False, random_allow_2=False):
        if not random_allow_1:
            notvalidate = True
            while notvalidate:
                pokemon1 = input("Digite o nome do primeiro Pokemon: ")
                os.system("cls")
                pokechoice1, pokechoice1name = self.pokenameValidation(pokemon1.capitalize(), pokelist)
        ...
        if not random_allow_2:
            ...
            while notvalidate:
                ...
                os.system("cls")
                pokechoice2, pokechoice2name = self.pokenameValidation(pokemon2.capitalize(), pokelist)
    ...
    def pokeMoveInput(self, pokename, lvllist, movelist, random_allow = False):
    ...
    def movePriority(self, prioritylist, move1, move2, speed1, speed2):
        validation = True
        while validation:
    ...
    def main_handler(self):
        ...
        try:
            ...
            battle = Pokemon_battle(types_matchup)
            ...
            pokemon1, pokemon2 = self.pokeInput(pokelist, random_allow_1=True, random_allow_2=True)
            print(pokemon1)

            # Preparando pokemons
            poke_1_moves, lvlpoke1 = self.pokeMoveInput(pokemon1[1], pokemovelist, pokemoves, True)
            poke_2_moves, lvlpoke2 = self.pokeMoveInput(pokemon2[1], pokemovelist, pokemoves, True)
            ...
            while battle_state:
                if pokemon1.currenthp > 0 and pokemon2.currenthp > 0:
                    ...
                    attackpriority = self.movePriority(prioritymoves, attack_1['name'], attack_2['name'],
...
if __name__ == '__main__':
    class_pokemon = Pokemon_main()
    class_pokemon.main_handler()